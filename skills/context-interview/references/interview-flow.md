...
acquisitions, or internal project names that differ from the company (e.g. a
`veritas_*` warehouse belongs to a company called "3Y Health"). If you don't have the
